...
function StudentCancelTutorship({ swal, tutorshipId, setState }) {
    ...
    const handleClick = e => {
        ...
        .then(() => setState(prevState => ({...prevState, renderSwitch: !prevState.renderSwitch})))
    ...
    return (
        <div className="StudentCancelTutorship-container">
            ...
            <div className="StudentCancelTutorship-buttons-container">
                <button onClick={handleClick} id="confirm" className="green">Yes, cancel tutorship</button>
                <button onClick={handleClick} id="cancel" className="red">No, return</button>
            </div>
        </div>
    )
}
